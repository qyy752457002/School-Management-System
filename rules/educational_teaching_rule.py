...
from views.models.teacher_extend_views import EducationalTeachingModel
...
class EducationalTeachingRule(object):
    ...
    async def get_educational_teaching_by_educational_teaching_id(self, educational_teaching_id):
        educational_teaching_db = await self.educational_teaching_dao.get_educational_teaching_by_educational_teaching_id(educational_teaching_id)
    ...
    async def delete_educational_teaching(self, educational_teaching_id):
        exists_educational_teaching = await self.educational_teaching_dao.get_educational_teaching_by_educational_teaching_id(educational_teaching_id)
        if not exists_educational_teaching:
            raise Exception(f"编号为的{educational_teaching_id}educational_teaching不存在")
        educational_teaching_db = await self.educational_teaching_dao.delete_educational_teaching(exists_educational_teaching)
    ...
    async def update_educational_teaching(self, educational_teaching:EducationalTeachingUpdateModel):
        exists_educational_teaching_info = await self.educational_teaching_dao.get_educational_teaching_by_educational_teaching_id(educational_teaching.educational_teaching_id)
        ...
        educational_teaching = await self.educational_teaching_dao.update_educational_teaching(educational_teaching, *need_update_list)
        return educational_teaching
