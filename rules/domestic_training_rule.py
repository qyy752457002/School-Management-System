...
class DomesticTrainingRule(object):
    ...
    async def delete_domestic_training(self, domestic_training_id):
        exists_domestic_training = await self.domestic_training_dao.get_domestic_training_by_domestic_training_id(domestic_training_id)
        if not exists_domestic_training:
            raise Exception(f"编号为的{domestic_training_id}domestic_training不存在")
    ...
    async def update_domestic_training(self, domestic_training:DomesticTrainingUpdateModel):
        exists_domestic_training_info = await self.domestic_training_dao.get_domestic_training_by_domestic_training_id(domestic_training.domestic_training_id)
        if not exists_domestic_training_info:
            raise Exception(f"编号为{domestic_training.domestic_training_id}的domestic_training不存在")
        need_update_list = []
        for key, value in domestic_training.dict().items():
            if value:
                need_update_list.append(key)
        domestic_training = await self.domestic_training_dao.update_domestic_training(domestic_training, *need_update_list)
        return domestic_training
...
#          domestic_training = orm_model_to_view_model(domestic_training_db, DomesticTrainingModel, exclude=[""])
          ...
          for item in domestic_training_db:
              domestic_training.append(orm_model_to_view_model(item, DomesticTrainingModel))
