...
class CampusCommunicationRule(object):
    ...
    async def get_campus_communication_by_id(self, campus_communication_id):
        campus_communication_db = await self.campus_communication_dao.get_campus_communication_by_id(
            campus_communication_id)
        # 可选 , exclude=[""]
    ...
    async def query_campus_communication_with_page(self, page_request: PageRequest, campus_communication_name=None,
        ...
        paging = await self.campus_communication_dao.query_campus_communication_with_page(campus_communication_name,
                                                                                          campus_communication_id,
                                                                                          campus_communication_no,
                                                                                          page_request)
