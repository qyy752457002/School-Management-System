...
from views.models.teacher_extend import TeacherTransactionModel,TeacherTransactionUpdateModel
...
class TeacherTransactionRule(object):
    ...
    async def get_teacher_transaction_by_teacher_transaction_id(self, teacher_transaction_id):
        teacher_transaction_db = await self.teacher_transaction_dao.get_teacher_transaction_by_teacher_transaction_id(teacher_transaction_id)
    ...
    async def delete_teacher_transaction(self, teacher_transaction_id):
        exists_teacher_transaction = await self.teacher_transaction_dao.get_teacher_transaction_by_teacher_transaction_id(teacher_transaction_id)
        if not exists_teacher_transaction:
            raise Exception(f"编号为的{teacher_transaction_id}teacher_transaction不存在")
        teacher_transaction_db = await self.teacher_transaction_dao.delete_teacher_transaction(exists_teacher_transaction)
    ...
    async def update_teacher_transaction(self, teacher_transaction:TeacherTransactionUpdateModel):
        exists_teacher_transaction_info = await self.teacher_transaction_dao.get_teacher_transaction_by_teacher_transaction_id(teacher_transaction.teacher_transaction_id)
        ...
        teacher_transaction = await self.teacher_transaction_dao.update_teacher_transaction(teacher_transaction, *need_update_list)
        return teacher_transaction
