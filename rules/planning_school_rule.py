...
class PlanningSchoolRule(object):
    ...
    async def query_planning_school_with_page(self, page_request: PageRequest, PlanningSchoolPageSearch  ):
        paging = await self.planning_school_dao.query_planning_school_with_page(PlanningSchoolPageSearch,  page_request)
