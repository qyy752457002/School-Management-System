...
for root, dirs, files in os.walk(directory_to_traverse):
    for file in files:
        ...
        # print(file_path,file)  # 打印文件的完整路径
    ...
    ) VALUES (  'country',  '%s', '%s','%s', True ,'2020-10-01 00:00:00','2020-10-01 00:00:00', False  );
    """
                ...
                for item in data:
                    ...
                    tt =formatted_string = insert_template % (item['value'], item['label'],file[0:6])
                    print(tt)
                    con.append(tt)
                ...
                #
with open("outputcountry.txt", "w", encoding="utf-8") as file:
    for line in con:
        file.write(line)
        file.write("\n")  # 添加换行符
