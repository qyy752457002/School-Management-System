...
class TeacherRetire(BaseDBModel):
    ...
    teacher_retire_id: Mapped[int] = mapped_column(primary_key=True, comment="变动主键id")
    ...
    retire_number: Mapped[str] = mapped_column(String(255), nullable=True, comment="离退休号", default='')
