...
class TeacherInfo(BaseDBModel):
    ...
    in_post: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否在编")
    ...
    current_technical_position: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="现专业技术职务")
    full_time_special_education_major_graduate: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                            comment="是否全日制特殊教育专业毕业")
    received_preschool_education_training: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                       comment="是否受过学前教育培训")
    full_time_normal_major_graduate: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                 comment="是否全日制师范类专业毕业")
    received_special_education_training: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                     comment="是否受过特教专业培训")
    has_special_education_certificate: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否有特教证书")
    information_technology_application_ability: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                            comment="信息技术应用能力")
    free_normal_college_student: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否免费师范生")
    participated_in_basic_service_project: Mapped[str] = mapped_column(String(255), nullable=True,
                                                                       comment="是否参加基层服务项目")
    ...
    special_education_teacher: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否特教")
    dual_teacher: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否双师型")
    has_occupational_skill_level_certificate: Mapped[str] = mapped_column(String(255), nullable=True,default="",
                                                                          comment="是否具备职业技能等级证书")
    enterprise_work_experience: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="企业工作时长")
    county_level_backbone: Mapped[str] = mapped_column(String(255), nullable=True, default="",comment="是否县级以上骨干")
    psychological_health_education_teacher: Mapped[str] = mapped_column(String(255), nullable=True,
                                                                        comment="是否心理健康教育教师")
