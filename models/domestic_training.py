...
class DomesticTraining(BaseDBModel):
    ...
    training_type: Mapped[str] = mapped_column(String(64), nullable=False, comment="培训类型枚举training_type_lv1")
    ...
    training_mode: Mapped[str] = mapped_column(String(64), nullable=False, comment="培训方式枚举training_mode_lv1")
