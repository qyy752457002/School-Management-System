...
class Institution(BaseDBModel):
    ...
    # institution_no: Mapped[str] = mapped_column(String(64), nullable=False, comment="编号")
    institution_code: Mapped[str] = mapped_column(String(64), nullable=False, comment="机构代码")
    institution_en_name: Mapped[str] = mapped_column(String(64), nullable=False, comment="单位名称英文")
    create_institution_date: Mapped[str] = mapped_column(String(64), nullable=False, comment="成立年月")
    ...
    detailed_address: Mapped[str] = mapped_column(String(64), nullable=False, comment="详细地址")
    ...
    web_url: Mapped[str] = mapped_column(String(64), nullable=False, comment="网址")

    institution_category: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 单位分类")
    institution_type: Mapped[str] = mapped_column(String(64), nullable=False, comment="单位类型 ")
    location_economic_attribute: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 所在地经济属性")
    leg_repr_certificatenumber: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 法人证书号")
    is_entity: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 是否实体")
    membership_no: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 隶属单位号")
    membership_category: Mapped[str] = mapped_column(String(64), nullable=False, comment=" 隶属单位类型")
