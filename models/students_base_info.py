...
class StudentBaseInfo(BaseDBModel):
    ...
    birthplace_district: Mapped[str] = mapped_column(String(64), nullable=False, default='',comment="出生地")
    ...
    residence_nature: Mapped[str] = mapped_column(String(64), nullable=False, default='',comment="户口性质")
    ...
    email_or_other_contact: Mapped[str] = mapped_column(String(64), nullable=True,default='', comment="电子信箱/其他联系方式")
    ...
    residence_address_detail: Mapped[str] = mapped_column(String(64), nullable=True, default='',comment="户口所在地（详细）")
    ...
    identity_card_validity_period: Mapped[str] = mapped_column(String(64), default='',nullable=True, comment="身份证件有效期")
