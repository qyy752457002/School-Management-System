from sqlalchemy import String, Date, BigInteger,BIGINT
...
class Teacher(BaseDBModel):
    ...
    teacher_id: Mapped[int] = mapped_column(BIGINT,primary_key=True, comment="教师ID",)
    ...
    teacher_employer: Mapped[int] = mapped_column(BIGINT, nullable=True, comment="任职单位")
