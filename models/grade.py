...
class Grade(BaseDBModel):
    ...
    is_enabled: Mapped[bool] = mapped_column( nullable=False  , comment="是否选择",default=False)
    is_graduation_grade: Mapped[bool] = mapped_column( nullable=False  , comment="是否毕业年级",default=False)
