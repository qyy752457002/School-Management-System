...
class StudentTemporaryStudy(BaseDBModel):
    ...
    origin_grade_id: Mapped[str] = mapped_column(String(30), nullable=True, comment="原年级ID", default='')

    origin_class_id: Mapped[str] = mapped_column(String(30), nullable=True, comment="原班级id", default='')
