...
class Classes(BaseDBModel):
    ...
    class_name: Mapped[str] = mapped_column(String(24), nullable=False, comment="班级名称")
    class_number: Mapped[str] = mapped_column(String(24), nullable=False, comment="班号")
    year_established: Mapped[str] = mapped_column(String(24), nullable=False, comment="建班年份")
    teacher_id_card: Mapped[str] = mapped_column(String(24), nullable=False, comment="班主任身份证")
    teacher_name: Mapped[str] = mapped_column(String(24), nullable=False, comment="班主任姓名")
    education_stage: Mapped[str] = mapped_column(String(24), nullable=False, comment="教育阶段")
    school_system: Mapped[str] = mapped_column(String(24), nullable=False, comment="学制")
    monitor: Mapped[str] = mapped_column(String(24), nullable=False, comment="班长")
    class_type: Mapped[str] = mapped_column(String(24), nullable=False, comment="中小学班级类型")
    is_bilingual_class: Mapped[str] = mapped_column(String(24), nullable=False, comment="是否少数民族双语教学班")
    major_for_vocational: Mapped[str] = mapped_column(String(24), nullable=False, comment="中职班级专业")
    bilingual_teaching_mode: Mapped[str] = mapped_column(String(24), nullable=False, comment="双语教学模式")
    ethnic_language: Mapped[str] = mapped_column(String(24), nullable=False, comment="少数民族语言")
