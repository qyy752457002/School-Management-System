...
class SchoolCommunication(BaseDBModel):
    """
    学校 通信表
    """
    __tablename__ = 'lfun_school_communications'
    __table_args__ = {'comment': '学校通信表'}
    ...
    school_web_url: Mapped[str] = mapped_column(String(64), nullable=False, comment="校园网域名")
