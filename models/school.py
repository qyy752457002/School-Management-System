...
class School(BaseDBModel):
    ...
    school_no: Mapped[str] = mapped_column(String(30), nullable=True,default='', comment="学校编号")
    school_code: Mapped[str] = mapped_column(String(30), nullable=True,default='', comment="学校标识码")
    school_operation_license_number: Mapped[str] = mapped_column(String(30), nullable=True,default='', comment="办学许可证号")
    ...
    school_level: Mapped[str] = mapped_column(String(20), nullable=True,default='', comment="学校星级")
    ...
    primary_school_system: Mapped[str] = mapped_column(String(20), nullable=True,default='', comment="小学学制")
