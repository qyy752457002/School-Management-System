...
class TransferDetails(BaseDBModel):
    ...
    original_district_area_id: Mapped[int] = mapped_column(String(64), nullable=True, comment="原行政属地区")
    original_region_province_id: Mapped[int] = mapped_column(String(64), nullable=True, comment="原管辖区域省")
    ...
    current_district_area_id: Mapped[int] = mapped_column(String(64), nullable=True, comment="现行政属地区")
