...
class ResearchAchievements(BaseDBModel):
    ...
    indexing_status: Mapped[str] = mapped_column(String(64), nullable=True, comment="论文收录情况枚举indexing_status_lv1")
    ...
    personal_rank: Mapped[str] = mapped_column(String(64), nullable=True, comment="本人排名枚举personal_rank_lv1")
