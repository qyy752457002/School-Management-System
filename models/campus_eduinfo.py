...
class CampusEduinfo(BaseDBModel):
    ...
    campus_id: Mapped[int] = mapped_column(BigInteger, nullable=True  , comment="校区id",default=0)

    is_ethnic_campus: Mapped[bool] = mapped_column( nullable=True,default=False , comment="是否民族校")
    ...
    is_affil_campus: Mapped[bool] = mapped_column( nullable=True,default=False , comment="是否附属校区")
    ...
    is_campus_counted: Mapped[bool] = mapped_column( nullable=True,default=False , comment="是否计校数")
