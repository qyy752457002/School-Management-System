...
class CampusEduinfo(BaseDBModel):
    ...
    is_ethnic_campus: Mapped[str] = mapped_column(String(64), nullable=False, comment="是否民族校")
    ...
    is_affil_campus: Mapped[str] = mapped_column(String(64), nullable=False, comment="是否附属校区")
    ...
    is_campus_counted: Mapped[str] = mapped_column(String(64), nullable=False, comment="是否计校数")
