...
class StudentFamilyInfo(BaseDBModel):
    ...
    phone_number: Mapped[str] = mapped_column(String(64), nullable=True, comment="手机号")
    ...
    family_member_occupation: Mapped[str] = mapped_column(String(128), nullable=True, comment="家庭成员职业")
