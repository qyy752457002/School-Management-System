...
class Course(BaseDBModel):
    ...
    def seed():
        return [
            ...
            Course( id=168 ,school_id=0,course_no="40",grade_id=0,  course_name="外语",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=169 ,school_id=0,course_no="41",grade_id=0,  course_name="英语",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=170 ,school_id=0,course_no="42",grade_id=0,  course_name="日语",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=171 ,school_id=0,course_no="43",grade_id=0,  course_name="俄语",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=172 ,school_id=0,course_no="49",grade_id=0,  course_name="其他外国语",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=173 ,school_id=0,course_no="60",grade_id=0,  course_name="综合实践活动",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中,普通高中'),
            Course( id=174 ,school_id=0,course_no="62",grade_id=0,  course_name="劳动与技术",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中'),
            Course( id=175 ,school_id=0,course_no="61",grade_id=0,  course_name="信息技术",created_uid=0,updated_uid=0,created_at=datetime.now(),updated_at=datetime.now(),is_deleted=False,district='',school_type='小学,初中'),
        ]
