...
class TeacherLearnExperience(BaseDBModel):
    ...
    education_obtained: Mapped[str] = mapped_column(String(64), nullable=False, comment="获的学历")
    country_or_region_of_education: Mapped[str] = mapped_column(String(64), nullable=False, comment="获得学历国家/地区")
    institution_of_education_obtained: Mapped[str] = mapped_column(String(64), nullable=False, comment="获得学历的院校机构")
    major_learned: Mapped[str] = mapped_column(String(64), nullable=False, comment="所学妆业")
    is_major_normal: Mapped[str] = mapped_column(String(64), nullable=False, comment="是否师范类专业")
    admission_date: Mapped[date] = mapped_column(Date, nullable=False, comment="入学时间")
    graduation_date: Mapped[date] = mapped_column(Date, nullable=False, comment="毕业时间")
    ...
    type_of_institution: Mapped[str] = mapped_column(String(64), nullable=False, comment="在学单位类别")
