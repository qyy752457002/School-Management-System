...
class TransferDetailsView(BaseView):
    ...
    async def get_transfer_details(self,
                  transfer_details_id: int= Query(None, title="transfer_detailsID", description="transfer_detailsID", example=1234)
                  ):
    ...
    async def get_transfer_details_all(self,teacher_id: int= Query(None, title="transfer_detailsID", description="transfer_detailsID", example=1234)):
...
class TeacherTransactionView(BaseView):
    ...
    async def get_teacher_transaction(self,
                  teacher_transaction_id: int= Query(None, title="teacher_transactionID", description="teacher_transactionID", example=1234)
                  ):
        res =await self.teacher_transaction_rule.get_teacher_transaction_by_teacher_transaction_id(teacher_transaction_id)
        return res
    ...
    async def get_teacher_transaction_all(self,teacher_id: int= Query(None, title="teacher_transactionID", description="teacher_transactionID", example=1234)):
