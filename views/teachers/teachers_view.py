...
class TeachersView(BaseView):
    ...
    # 在职教职工信息
    # 获取教职工基本信息
    async def get_teacherinfo(self, teacher_id: str = Query(None, title="教师名称", description="教师名称", min_length=1,
                                                       max_length=20,
                                                       example='张三')):
    ...
    # 删除教职工基本信息
    async def delete_teacherinfo(self, teacher_id: str = Query(None, title="教师名称", description="教师名称", min_length=1,
                                                       max_length=20,
                                                       example='张三')):
