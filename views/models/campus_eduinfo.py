...
class CampusEduInfo(BaseModel):
    ...
    is_ethnic_campus: str = Field(..., title="", description="是否民族校", examples=['是'])
    ...
    is_affil_campus: str = Field(..., title="", description="是否附属校区", examples=['是'])
    ...
    is_campus_counted: str = Field(..., title="", description="是否计校数", examples=['是'])
