...
class School(BaseModel):
    ...
    school_no: str |None= Field(..., title="学校编号", description="学校编号",examples=['SC2032633'])
    ...
    created_uid: int |None = Field(..., title="", description="创建人",examples=['1'])
    school_short_name: str|None = Field('', title="", description="园所简称",examples=['MXXX'])
    school_en_name: str|None = Field('', title="", description="园所英文名称",examples=['MinxingPrimarySCHOOL'])
    create_school_date: str|None = Field(..., title="", description="建校年月",examples=['2021-10-10 00:00:00'])
    ...
    founder_name: str|None = Field(..., title="", description="举办者名称",examples=['上海教育局'])
    founder_code: str |None= Field(..., title="", description="举办者识别码",examples=['SC562369322SG'])
    ...
    school_closure_date: str|None = Field(..., title="", description="学校关闭日期",examples=[''])
    department_unit_number: str|None = Field(..., title="", description="属地管理行政部门单位号",examples=['SC562369322SG'])
    sy_zones: str|None = Field(..., title="", description="属地管理行政部门所在地地区",examples=['铁西区'])
    historical_evolution: str|None = Field(..., title="", description="历史沿革",examples=['xxxxxxxxxxxxxxxxxxxx'])
    sy_zones_pro: str|None = Field(..., title="", description="属地管理教育行政部门所在地（省级）",examples=['沈阳'])
    # primary_school_system: str|None = Field(..., title="", description="小学学制",examples=['6'])
    primary_school_entry_age: str |None= Field(..., title="", description="小学入学年龄",examples=['6'])
    # junior_middle_school_system: str |None= Field(..., title="", description="初中学制",examples=['3'])
    junior_middle_school_entry_age: str|None = Field(..., title="", description="初中入学年龄",examples=['12'])
...
class SchoolKeyInfo(BaseModel):
    ...
    school_no:str|None= Query(None, title="学校编号", description="学校编号/园所代码",min_length=1,max_length=20,example='SC2032633')
    old_school_no:str|None = Query(None, title="学校编号", description="学校编号/园所代码", max_length=50,example='SC2032633')
    planning_school_id: int|str = Field(None, title="", description="规划校id",examples=['1'])
...
class SchoolKeyAddInfo(BaseModel):
    ...
    school_no:str|None= Field(..., title="学校编号", description="学校编号/园所代码",min_length=1,max_length=50,example='SC2032633')
    old_school_no:str|None= Field( '', title="学校编号", description="学校编号/园所代码", max_length=50,example='SC2032633')
...
class SchoolPageSearch(BaseModel):
    ...
    planning_school_no: str|None = Query("", title="学校编号", description="学校编号/园所代码", max_length=50, )
    ...
    old_school_no: str|None = Query("", title=" ", description="", )
