...
class School(BaseModel):
    ...
    school_no: str |None= Field(None, title="学校编号", description="学校编号",examples=['SC2032633'])
...
class SchoolKeyAddInfo(BaseModel):
    ...
    school_no:str|None= Field(None, title="学校编号", description="学校编号/园所代码",min_length=1,max_length=50,example='SC2032633')
