...
class NewTeacher(BaseModel):
    ...
    """
    teacher_id: int = Field(..., title="教师ID", description="教师ID")
    name: str = Query(None, title="姓名", description="姓名", example="张三")
    id_number: str = Query(None, title="身份证号", description="身份证号", example="123456789012345678")
    gender: str = Query(None, title="性别", description="性别", example="男")
    employer: str = Query(None, title="任职单位", description="任职单位", example="xx学校")
    highest_education: str = Query(None, title="最高学历", description="最高学历", example="本科")
    political_status: str = Query(None, title="政治面貌", description="政治面貌", example="群众")
    in_post: str = Query(None, title="是否在编", description="是否在编", example="是")
    employment_form: str = Query(None, title="用人形式", description="用人形式", example="合同")
    enter_school_time: date = Query(None, title="进本校时间", description="进本校时间", example="2010-01-01")
    approval_status: str = Query(None, title="审核状态", description="审核状态", example="通过")
