...
class PlanningSchool(BaseModel):
    ...
    planning_school_code: str = Field(..., title="规划校标识码", description=" 规划校标识码",
    ...
    planning_school_en_name: str = Field('', title="规划校英文名称", description="规划校英文名称",
                                         examples=['MinxingPrimarySCHOOL'])
    create_planning_school_date: str = Field(..., title="建校年月", description="建校年月",
                                             examples=['2021-10-10 00:00:00'])
    social_credit_code: str = Field(..., title="统一社会信用代码", description="统一社会信用代码",
    ...
    department_unit_number: str = Field(..., title="属地管理行政部门单位号", description="属地管理行政部门单位号",
                                        examples=['SC562369322SG'])
    sy_zones: str = Field(..., title="属地管理行政部门所在地地区", description="属地管理行政部门所在地地区",
                          examples=['铁西区'])
    historical_evolution: str = Field(..., title="历史沿革", description="历史沿革", examples=['xxxxxxxxxxxxxxxxxxxx'])
    sy_zones_pro: str = Field(..., title="属地管理教育行政部门所在地（省级）",
