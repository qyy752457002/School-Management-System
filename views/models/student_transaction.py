...
class StudentEduInfo(BaseModel):
    student_id: str|int|None = Query(..., description="学生id", title='学生id', min_length=1, max_length=20,
    ...
    edu_number: str|None = Query("", description="国家学籍号码", min_length=1, max_length=20,
                                   examples=["DF23321312"]),
    school_id: str|int|None = Query(..., title="", description="学校ID", examples=["102"])
    ...
    id: str|int|None = Query(0, description="id", examples=["1"], example="1"),
    relation_id: str|int|None = Query(0, description="关联id", examples=["1"], example="1"),
    remark: str|None = Query('', title="", description="", examples=["备注"])
    process_instance_id: str|int|None = Field(0, title="", description="", examples=['1'])
