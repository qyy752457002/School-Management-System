...
is_school_counted
    ...
    #
    # deleted: int = Field(0, title="", description="删除态", examples=['0'])
    # created_uid: int = Field(..., title="", description="创建人", examples=['1'])
    # updated_uid: int = Field(..., title="", description="更新人", examples=['1'])
    # created_time: str = Field(..., title="", description="创建时间", examples=['2021-10-10 00:00:00'])
    # updated_time: str = Field(..., title="", description="更新时间", examples=['2021-10-10 00:00:00'])
