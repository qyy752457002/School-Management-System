...
campus_leader_position
    ...
    campus_web_url: str = Field(None, title="", description="校园网域名",examples=['WW.SS.CC'])
    campus_leader_name: str = Field(None, title="", description="校区负责人姓名",examples=['3'])

    campus_leader_position: str = Field(None, title="", description="校区负责人职位",examples=['3'])
