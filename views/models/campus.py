...
class Campus(BaseModel):
    ...
    campus_no: str = Field(..., title="学校编号", description="学校编号",examples=['SC2032633'])
    ...
    campus_type: str = Field(..., title="", description=" 学校类型",examples=['中小学'])
    campus_operation_type: str = Field(..., title="", description="办学类型/学校性质",examples=['学前教育'])
    ...
    campus_org_type: str = Field(..., title="", description=" 学校办别",examples=['民办'])
    campus_level: str = Field(..., title="", description=" 学校星级",examples=['5'])
    ...
    campus_closure_date: str = Field(..., title="", description="学校关闭日期",examples=[''])
...
class CampusBaseInfo(BaseModel):
    campus_name: str = Field(..., title="学校名称", description="1-20字符",examples=['XX小学'])
    campus_short_name: str = Field(..., title="", description="园所简称",examples=['MXXX'])
    campus_code: str = Field(..., title="", description=" 园所标识码",examples=['SC562369322SG'])
    create_campus_date: str = Field(..., title="", description="建校年月",examples=['2021-10-10 00:00:00'])
    founder_type: str = Field(..., title="", description="举办者类型",examples=['地方'])
