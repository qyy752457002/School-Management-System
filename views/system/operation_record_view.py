...
from views.models.operation_record import OperationRecord, OperationType, ChangeModule, OperationType
...
class OperationRecordView(BaseView):
    ...
    async def page(self,
                   ...
                   operation_target_type: OperationType = Query(None, title="", description="操作主体类型",
                   ...
                   operation_module: ChangeModule = Query(None, title="", description="操作模块", example='admin',
