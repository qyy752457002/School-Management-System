...
class OperationRecordView(BaseView):
    ...
    async def page(self,
        ...
        res = OperationRecord(action_target_id='1',action_type='1',ip='1',change_data='1',change_field='1',change_item='1',timestamp='1',action_reason='1',doc_upload='1',status='1',account='1',operator='1',module='1',target='1', )
